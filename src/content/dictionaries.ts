...
export const dictionaries = {
  el: {
    ...
    nav: {
      ...
      systemicConstellation: "Συστημική Αναπαράσταση",
    ...
    common: {
      ...
      treatmentDisclaimer:
        "Στις τιμές περιλαμβάνεται ο ΦΠΑ 24%. - Καμία από τις πρακτικές που παρέχονται στην Inner Glow δεν αντικαθιστά την ιατρική διάγνωση, θεραπεία ή ψυχοθεραπευτική υποστήριξη, ούτε προτείνεται η διακοπή οποιασδήποτε αγωγής· λειτουργούν συμπληρωματικά, με στόχο την αυτογνωσία, τη συναισθηματική αποφόρτιση και την προσωπική ενδυνάμωση.",
      submit: "Αποστολή",
    },
    cookieConsent: {
    ...
    about: {
      ...
      body:
        "Στην Inner Glow ανοίγουμε έναν χώρο εσωτερικής εξερεύνησης, φροντίδας και προσωπικής μεταμόρφωσης. Μέσα από πρακτικές αυτογνωσίας, θεραπευτικές προσεγγίσεις και βιωματικές συναντήσεις, συνοδεύουμε κάθε άνθρωπο στο δικό του ταξίδι προς περισσότερη επίγνωση, ισορροπία και επαφή με αυτό που πραγματικά χρειάζεται.",
      items: [
    ...
    healing: {
      ...
      treatments: [
        ...
        },
        {
          ...
          sections: [
            {
              title: "Τι προσφέρει",
              body: "Να δεις τη ρίζα ενός προβλήματος ή μοτίβου που σε ταλαιπωρεί, να απελευθερωθείς από φόβους ή ανεξήγητα βάρη, να νιώσεις βαθύτερη κατανόηση για τον εαυτό σου και τη διαδρομή σου, να συνδεθείς με το βαθύτερο νόημα της ψυχής σου",            },
            {
              title: "Για ποιον είναι",
              body: "Είναι για όσους νιώθουν ότι επαναλαμβάνουν μοτίβα στη ζωή τους χωρίς να καταλαβαίνουν το «γιατί». Είναι για όσους κουβαλούν έντονα συναισθήματα, φόβους ή μπλοκαρίσματα που δεν εξηγούνται εύκολα με τη λογική, αλλά και για εκείνους που θέλουν να γνωρίσουν βαθύτερα τον εαυτό τους.",
            },
          ],
          coordinator: {
            show: false,
        ...
        },
        {
          ...
          workshopCta: {
            intro:
              "Τη Συστημική Αναπαράσταση συντονίζει ο ψυχολόγος και Αναγνωρισμένος Συστημικός Αναπαραστάτης Ε.Ι.Σ.Α.® (DGfS), Κανάρης Κάραλης.",
        ...
        },
        {
          ...
          sections: [
            {
              title: "Τι προσφέρει",
              body: "Οι ομαδικοί διαλογισμοί προσφέρουν την εμπειρία της συνύπαρξης μέσα σε ένα ήρεμο και υποστηρικτικό περιβάλλον. Η παρουσία της ομάδας δημιουργεί μια αίσθηση σύνδεσης και κοινής πρόθεσης, βοηθώντας τον κάθε συμμετέχοντα να αφεθεί πιο εύκολα στη διαδικασία, να νιώσει ότι δεν είναι μόνος και να καλλιεργήσει μια βαθύτερη επαφή με τον εαυτό του.",
            },
            {
              title: "Για ποιον είναι",
              body: "Απευθύνονται σε όσους νιώθουν την ανάγκη να κάνουν μια παύση, να αποφορτιστούν και να ξανασυνδεθούν με τον εαυτό τους. Είναι κατάλληλοι για ανθρώπους που βιώνουν ένταση, άγχος ή κούραση από τους ρυθμούς της καθημερινότητας, αλλά και για όσους θέλουν απλώς να χαρίσουν στον εαυτό τους μια στιγμή ηρεμίας, φροντίδας και ανάσας.",
            },
          ],
          coordinator: {
            show: false,
      ...
      pricingTitle: "Τιμή",
      pricingBody:
        "Συμπλήρωσε τη φόρμα ενδιαφέροντος για την θεραπεία που σου ταιριάζει και θα επικοινωνήσουμε μαζί σου.",
    },
    contact: {
      title: "Επικοινωνία",
      body:
  ...
  en: {
    ...
    common: {
      brand: "Inner Glow",
      switchLanguage: "EL",
      bookDiscovery: "Book an acquaintance 15min call",
    ...
    contact: {
      title: "Contact",
      body:
        "If you would like to learn more about our services, you can schedule a free 15-minute phone appointment.",
    ...
    contactRequest: {
      ...
      body:
        "Fill in your details and we will contact you for a short free of charge 15min call.",
