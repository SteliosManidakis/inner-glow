    ...
    healing: {
      ...
      treatments: [
        ...
        },
        {
          ...
          body:
            "Μια τεχνική που μας βοηθά να αποκτήσουμε πρόσβαση σε μνήμες και βιώματα που βρίσκονται βαθιά στο υποσυνείδητο. Μέσα από μια φυσική και ασφαλή διαδικασία ύπνωσης",
          image: "/images/placeholders/healing.png",
          sections: [
            {
              title: "Τι προσφέρει",
              body: "Η ύπνωση μπορεί να λειτουργήσει θεραπευτικά και διερευνητικά σε θέματα ευεξίας· δεν αντικαθιστά την ιατρική. Πολλά από τα μπλοκαρίσματα που νιώθουμε σήμερα — φόβοι, επαναλαμβανόμενα μοτίβα, συναισθηματικά βάρη — έχουν ρίζες σε παλαιότερες εμπειρίες. Η αναδρομή δεν είναι απλώς «αναβίωση»· είναι κατανόηση, αποδοχή και λύτρωση.",
            },
            {
              title: "Για ποιον είναι",
              body: "Για ανθρώπους που θέλουν να εξερευνήσουν και να κατανοήσουμε βαθύτερα εσωτερικά θέματα, επαναλαμβανόμενα μοτίβα ή συναισθηματικές συνδέσεις.",
            },
          ],
          coordinator: {
            show: false,
